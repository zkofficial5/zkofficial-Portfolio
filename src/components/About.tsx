...
const codePhases = ["< Zoya />", "{ developer }", "// writer", "~ creator"];
...
const achievements = [
  {
    icon: Award,
    title: "Vice President, TECHNOVA 2k25",
    desc: "Led 1000+ attendees, 30+ colleges — as VP for the event.",
  },
  {
    icon: GraduationCap,
    title: "Class Representative",
    desc: "Elected all years of undergraduate program",
  },
  {
    icon: Briefcase,
    title: "Internship, Infotech Prodigy",
    desc: "Multiple project submissions",
  },
  {
    icon: ScrollText,
    title: "Certifications",
    desc: "Python, AI, and emerging technologies",
  },
];
...
const About = () => {
  ...
  useEffect(() => {
    const t = setInterval(
      () => setPhraseIdx((i) => (i + 1) % codePhases.length),
      2500,
    );
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(201,81,122,0.12), transparent 70%)",
          filter: "blur(80px)",
        }}
      />
      <div
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center relative z-10">
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 0 40px rgba(201,81,122,0.07), inset 0 0 40px rgba(201,81,122,0.02)",
              minHeight: "160px",
            }}
          >
            ...
            <div className="absolute top-4 right-4 flex gap-1.5">
              <span
                ...
                style={{ backgroundColor: "#C9517A", opacity: 0.5 }}
              />
              <span
                className="w-2.5 h-2.5 rounded-full"
                style={{ backgroundColor: "#7C3AED", opacity: 0.4 }}
              />
              <span
                className="w-2.5 h-2.5 rounded-full"
            ...
            <p
              ...
              style={{ color: "rgba(201,81,122,0.5)" }}
            >
              identity.ts
            </p>
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, transparent, rgba(201,81,122,0.4), transparent)",
              }}
            />
          </div>
          ...
          >
            <div
              className="animate-ticker flex whitespace-nowrap gap-0"
              style={{ width: "200%" }}
            >
        ...
        >
          ...
          <p
            className="font-body leading-relaxed mb-6 text-base md:text-lg"
            style={{ color: "rgba(255,255,255,0.75)" }}
          >
            I'm a full stack developer who builds on both ends of the stack— and
            I build the same way I approach writing, with intention, structure,
            and an eye for what someone actually needs. I care about the
            details, in code and in craft. Clean architecture, thoughtful
            design, and work that actually means something. So to sum it up; I
            write code, prose, and the occasional argument that semicolons are
            an art form.
          </p>
