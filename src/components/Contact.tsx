...
const Contact = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.error(
        "Something went wrong. Please email me directly at zkofficial108@gmail.com",
      );
    } finally {
  ...
  const contactCards = [
    ...
    },
    {
      icon: Mail,
      label: "Email",
      value: "zkofficial108@gmail.com",
      href: "mailto:zkofficial108@gmail.com",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(201,81,122,0.1), transparent 70%)",
          filter: "blur(80px)",
        }}
      />
      <div
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          ...
          <h2
            ...
            style={{
              ...
              color: "#C9517A",
              textShadow: "0 0 40px rgba(201,81,122,0.3)",
            }}
          >
            Together
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            >
              I'm open to freelance projects, collaborations, and internship
              opportunities. Reach out and I'll get back to you within 48 hours.
            </p>
